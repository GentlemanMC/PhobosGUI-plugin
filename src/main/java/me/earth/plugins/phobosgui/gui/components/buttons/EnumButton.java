...
public class EnumButton<E extends Enum<E>> extends Button
{
    ...
    public EnumButton(final EnumSetting<E> setting) {
    ...
    public void drawScreen(final int n, final int n2, final float n3) {
        ...
        PhobosTextManager.getInstance().drawStringWithShadow(this.setting.getName() + " " + "\u00A77" + this.setting.getValue().name(), this.x + 2.3f, this.y - 1.7f - PhobosGui.getInstance().getTextOffset(), this.getState() ? -1 : -5592406);
    }
